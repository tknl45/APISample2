...
namespace APISample.Helper
{
	public class RedisService
	{
        ...
        static RedisService(){
            ...
            var url = Configuration["RedisConnection:ConnectionString"];
            var port = Int16.Parse(Configuration["RedisConnection:ConnectionPort"]);
            var dbIndex = Int16.Parse(Configuration["RedisConnection:DbIndex"]);
        ...
        public List<string> GetKeys(string keyPattern="*")
        {
            ...
            foreach (var key in GetServer.Keys(0, keyPattern))
            {
                list.Add(key);
            }
